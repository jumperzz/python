...
button_point = Button(frame_bord,text = '.',width = 5,height =2,command = lambda:nums('.')).grid(row = 4,column = 1)
button_eql = Button(frame_bord,text = '=',width = 5,height =2,command = toequal).grid(row = 4,column = 2)
